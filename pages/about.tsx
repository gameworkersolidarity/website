            ...
            <div className='grid lg:grid-cols-2 lg:col-span-2 gap-6'>
              <div className='space-y-5'>
                <section className='space-y-3'>
                  ...
                  <p>Austin Kelmore, Game worker and union organizer, IWGB.&nbsp;<a href='https://bsky.app/profile/austinkelmore.com' className='link'>@austinkelmore.com</a></p>
                  <p>Jamie Woodcock, Senior Lecturer, King's College London.&nbsp;<a href='https://twitter.com/jamie_woodcock' className='link'>@jamie_woodcock</a></p>
                ...
                <section className='space-y-3'>
                  ...
                  <p><a className='link' href={`${projectStrings.blueskyProfile}`}>
                    Bluesky
                  </a></p>
