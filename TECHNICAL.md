...
- Modify the `POSTGRES_URL` in your `.env` file to `postgres://postgres@localhost:54320/gwsp`
- Modify the `docker-compose.yml` file's `POSTGRES_DB` to match the above `gwsp`
