...
const fields: Array<keyof OrganisingGroup['fields']> = ['LastModified', 'slug', 'Name', 'Full Name', 'Country', 'countryCode', 'countryName', 'Solidarity Actions', 'IsUnion', 'Website', 'Twitter', 'Bluesky']
