...
export const CountrySchema = z.object({
    ...
    bbox: z.union([z.record(z.string(), z.unknown()), z.array(z.unknown()), z.string(), z.number(), z.boolean()]).optional().nullable(),
    isoA3: z.string().optional(),
    coordinates: z.record(z.string(), z.unknown()).and(z.object({
        latitude: z.number(),
        longitude: z.number()
    })).optional(),
    path: z.string().optional(),
...
export const AboutPageSchema = z.object({
    ...
    credits: z.record(z.string(), z.unknown()).and(z.object({
        root: z.object({
            type: z.string(),
            children: z.array(z.record(z.string(), z.unknown()).and(z.object({
                type: z.any(),
...
export const ActionSchema: z.ZodSchema<Action> = z.lazy(() => z.object({
    id: z.string(),
    generateSlug: z.boolean().optional().nullable(),
    slug: z.string(),
    name: z.string(),
    ...
    categories: z.array(z.union([z.string(), CategorySchema])).optional().nullable(),
    headcount: z.number().optional().nullable(),
    initiator: z.union([z.literal("WORKER_LED"), z.literal("BOSS_LED"), z.literal("OTHER")]).optional().nullable(),
    link: z.string().optional().nullable(),
    documents: z.array(z.union([z.string(), MediaSchema])).optional().nullable(),
    ...
    companies: z.array(z.union([z.string(), CompanySchema])).optional().nullable(),
    organisingGroups: z.array(z.union([z.string(), OrganisingGroupSchema])).optional().nullable(),
    campaigns: z.object({
...
export const OrganisingGroupSchema: z.ZodSchema<OrganisingGroup> = z.lazy(() => z.object({
    id: z.string(),
    airtableId: z.string().optional().nullable(),
    generateSlug: z.boolean().optional().nullable(),
    slug: z.string(),
...
export const CampaignSchema: z.ZodSchema<Campaign> = z.lazy(() => z.object({
    id: z.string(),
    generateSlug: z.boolean().optional().nullable(),
    slug: z.string(),
    name: z.string(),
    ...
    emoji: z.string().optional().nullable(),
    actions: z.array(z.union([z.string(), ActionSchema])).optional().nullable(),
    highlightedActionAttribute: z.union([z.literal("companies"), z.literal("countries"), z.literal("organisingGroups"), z.literal("categories"), z.literal("headcount"), z.literal("location"), z.literal("name")]).optional().nullable(),
    path: z.string().optional(),
    url: z.string().optional(),
    adminPath: z.string().optional(),
